---
name: autopilot-fable-medium
description: Autopilot worker running on Fable at medium effort. Use only when the autopilot skill delegates a task to this model and effort.
model: fable
effort: medium
---

---
name: autopilot-opus-max
description: Autopilot worker running on Opus at max effort. Use only when the autopilot skill delegates a task to this model and effort.
model: opus
effort: max
---

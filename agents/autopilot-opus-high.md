---
name: autopilot-opus-high
description: Autopilot worker running on Opus at high effort. Use only when the autopilot skill delegates a task to this model and effort.
model: opus
effort: high
---

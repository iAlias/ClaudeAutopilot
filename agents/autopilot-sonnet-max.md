---
name: autopilot-sonnet-max
description: Autopilot worker running on Sonnet at max effort. Use only when the autopilot skill delegates a task to this model and effort.
model: sonnet
effort: max
---

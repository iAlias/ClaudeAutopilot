---
name: autopilot-fable-high
description: Autopilot worker running on Fable at high effort. Use only when the autopilot skill delegates a task to this model and effort.
model: fable
effort: high
---

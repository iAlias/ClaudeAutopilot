---
name: autopilot-fable-max
description: Autopilot worker running on Fable at max effort. Use only when the autopilot skill delegates a task to this model and effort.
model: fable
effort: max
---

---
name: autopilot-fable-xhigh
description: Autopilot worker running on Fable at xhigh effort. Use only when the autopilot skill delegates a task to this model and effort.
model: fable
effort: xhigh
---

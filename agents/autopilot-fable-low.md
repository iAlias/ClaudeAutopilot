---
name: autopilot-fable-low
description: Autopilot worker running on Fable at low effort. Use only when the autopilot skill delegates a task to this model and effort.
model: fable
effort: low
---

---
name: autopilot-opus-medium
description: Autopilot worker running on Opus at medium effort. Use only when the autopilot skill delegates a task to this model and effort.
model: opus
effort: medium
---

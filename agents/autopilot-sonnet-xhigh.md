---
name: autopilot-sonnet-xhigh
description: Autopilot worker running on Sonnet at xhigh effort. Use only when the autopilot skill delegates a task to this model and effort.
model: sonnet
effort: xhigh
---

---
name: autopilot-sonnet-low
description: Autopilot worker running on Sonnet at low effort. Use only when the autopilot skill delegates a task to this model and effort.
model: sonnet
effort: low
---

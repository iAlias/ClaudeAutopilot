---
name: autopilot-sonnet-high
description: Autopilot worker running on Sonnet at high effort. Use only when the autopilot skill delegates a task to this model and effort.
model: sonnet
effort: high
---

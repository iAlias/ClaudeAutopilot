---
name: autopilot-opus-low
description: Autopilot worker running on Opus at low effort. Use only when the autopilot skill delegates a task to this model and effort.
model: opus
effort: low
---

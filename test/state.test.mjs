...
test('readState defaults to suggest with permissions off', () => {
  assert.deepEqual(readState(), { mode: 'suggest', permissions: false, wrappedStatusline: null })
})
...
test('writeState merges patches', () => {
  ...
  assert.deepEqual(readState(), { mode: 'auto', permissions: true, wrappedStatusline: null })
})
